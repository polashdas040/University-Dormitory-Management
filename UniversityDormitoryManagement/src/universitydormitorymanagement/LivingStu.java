...
public class LivingStu {
    ...
    public void studentsTableLocal(JTable table, String valueToSearch) {
        ...
        try {
            ps = con.prepareStatement("SELECT * FROM local_students WHERE CONCAT (phone)LIKE ? and local_students.living_status='Living'");
            ...
            Logger.getLogger(LivingStu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void studentsTableInt(JTable table, String valueToSearch) {
        ...
        PreparedStatement ps;
        try {
            ps = con.prepareStatement("SELECT * FROM int_students WHERE CONCAT (phone)LIKE ? and int_students.living_status='Living'");
            ps.setString(1, "%" + valueToSearch + "%");
