...
public class NotWorkingEmployees extends javax.swing.JFrame {

    NotWorkingEmp emp = new NotWorkingEmp();

    public NotWorkingEmployees() {
        initComponents();
        visibleLoc();
        visibleInt();
    }
    ...
    private void initComponents() {
        ...
        if (loc_jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            loc_jTable1.getColumnModel().getColumn(8).setMaxWidth(300);
            loc_jTable1.getColumnModel().getColumn(9).setPreferredWidth(120);
            loc_jTable1.getColumnModel().getColumn(9).setMaxWidth(300);
        ...
        if (int_jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            int_jTable1.getColumnModel().getColumn(1).setPreferredWidth(150);
            int_jTable1.getColumnModel().getColumn(1).setMaxWidth(120);
            ...
            int_jTable1.getColumnModel().getColumn(11).setMaxWidth(150);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        setVisible(false);
        try{
           Home.jLabel30.setForeground(new Color(0,0,0)); 
